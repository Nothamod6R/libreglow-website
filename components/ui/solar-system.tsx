        ...
        */}
        ...
        >
          ...
          */}
          ...
          >
            {/* Glowing aura */}
            <div className="absolute w-[90px] h-[90px] md:w-[120px] md:h-[120px] rounded-full filter blur-md animate-custom-sun-pulse z-10 " />
            ...
            {centerLogo ? (
              ...
              <div className="w-14 h-14 md:w-20 md:h-20 font-extrabold p-4 rounded-full border-2  z-20 bg-zinc-950 flex items-center justify-center  relative">
                <img src={"https://avatars.githubusercontent.com/u/310168718?s=200&v=4"}/>
                </div>
            )}
