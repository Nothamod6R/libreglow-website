...
const DEFAULT_PARAGRAPHS = [
  [
    "LibreGlow builds modern open-source software",
    "designed for Linux users, creators,",
    "developers, and privacy-conscious people.",
  ],
  [
    "Every application is crafted with simplicity,",
    "performance, and beautiful user experience.",
    "No subscriptions. No tracking.",
    "Just software that belongs to everyone.",
  ],
];
...
export function MagneticSpotlightMarquee({
  ...
  footerText =
    "LibreGlow is an independent open-source organization building beautiful, privacy-respecting software for Linux. We create fast, modern, and community-driven applications that empower creators, developers, and everyday users — without subscriptions, tracking, or unnecessary complexity.",}: MagneticSpotlightMarqueeProps) {
